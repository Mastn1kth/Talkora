  ...
  return <>
    ...
    <div className="league-layout">
      <section className="league-board">
        ...
        <div className="preview-notice"><CircleHelp size={18}/><span>{online ? 'Сервер проверяет первые ответы в основном пути, мини-тестах, личных словах и готовых темах. Только проверенные очки входят в недельную таблицу.' : 'Ты офлайн. Показана последняя сохранённая таблица; локальные результаты появятся в общем прогрессе, но без серверной сессии не попадут в лигу.'}</span></div>
      ...
      <aside className="league-rules"><span className="quick-icon mint"><Leaf size={27}/></span><h2>Свой темп.<br/>Своя команда.</h2><p>Каждую неделю — группа до 12 участников со схожей активностью в прошлую неделю.</p><ol><li><span>01</span><div><strong>Проходи основной путь</strong><p>Проверенные уроки и мини-тесты приносят очки лиги.</p></div></li><li><span>02</span><div><strong>Выбирай своё</strong><p>Онлайн-тренировки личных слов и шести готовых тем тоже входят в рейтинг.</p></div></li><li><span>03</span><div><strong>Открывай новую лигу</strong><p>В группах от трёх человек место определяет следующую ступень.</p></div></li></ol><p className="fine-print">Личные слова, почта и учебные материалы не показываются другим участникам. Офлайн-тренировки дают общий XP без очков лиги.</p></aside>
    </div>
  </>;
}
